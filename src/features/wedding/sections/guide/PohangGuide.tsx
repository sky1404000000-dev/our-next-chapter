...
const folderArtwork = [
  {
    src: '/images/guide/folders/green-striped.png',
    className: styles.folderArtworkGreen
  },
  {
    src: '/images/guide/folders/yellow-gingham.png',
    className: styles.folderArtworkYellow
  },
  {
    src: '/images/guide/folders/orange-polka.png',
    className: styles.folderArtworkOrange
  },
  {
    src: '/images/guide/folders/blue-floral.png',
    className: styles.folderArtworkBlue
  }
] as const;
...
export default function PohangGuide() {
  ...
  const [
    selectedFolder,
    setSelectedFolder
  ] = useState<PohangFolder | null>(null);
