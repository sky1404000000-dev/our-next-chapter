import { HeartHandshake, Images, Map, MapPin, UsersRound, WalletCards } from 'lucide-react';
...
export default function QuickMenu({ showAccount }: QuickMenuProps) {
  const menuItems: MenuItem[] = [
    ...
    { label: '저희 소개', href: '#about-us', icon: UsersRound },
    { label: '우리 이야기', href: '#our-story', icon: HeartHandshake },
    { label: '갤러리', href: '#gallery', icon: Images },
    { label: '포항 가이드', href: '#pohang-guide', icon: Map },
